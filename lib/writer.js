...
class Writer {
  ...
  createOutputFiles () {
    ...
    // Copy Bootstrap icons if needed
    this.fs.copySync(this.findAsset('bootstrap/dist/js/bootstrap.bundle.min.js'), this.path.join(assetsPath, 'bootstrap.bundle.min.js'));
    this.fs.copySync(this.findAsset('bootstrap/dist/js/bootstrap.bundle.min.js.map'), this.path.join(assetsPath, 'bootstrap.bundle.min.js.map'));
